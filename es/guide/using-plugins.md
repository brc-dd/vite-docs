...
Consulta la [Guía de API de complementos](./api-plugin#orden-de-complementos) para obtener información detallada, y tener en cuenta la etiqueta `enforce` y las instrucciones de uso para complementos populares en lista de compatibilidad de [Complementos Vite Rollup](https://vite-rollup-plugins.patak.dev).
...
Consulta la [Guía de API de complementos](./api-plugin) para obtener documentación sobre la creación de complementos.
