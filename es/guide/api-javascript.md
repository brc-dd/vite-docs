...
**Relacionado:** [server.fs.allow](../config/server-options#server-fs-allow)
...
**Relacionado:** [Archivos `.env`](./env-and-mode#archivos-env)
...
**Relacionado:** [Normalización de rutas](./api-plugin#normalizacion-de-rutas)
