...
- **Tipo:** `Record<string, string | ProxyOptions>`
  ...
  En algunos casos, es posible que también desees configurar el servidor de desarrollo relacionado (por ejemplo, para agregar middlewares personalizados a la aplicación interna [connect](https://github.com/senchalabs/connect)). Para hacerlo, debes escribir tu propio [complemento](../guide/using-plugins) y usar la función [configureServer](../guide/api-plugin#configureserver).
