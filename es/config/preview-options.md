...
- **Tipo:** `string | boolean`
- **Por defecto:** [`server.host`](./server-options#server-host)
...
- **Tipo:** `boolean`
- **Por defecto:** [`server.strictPort`](./server-options#server-strictport)
...
- **Por defecto:** [`server.https`](./server-options#server-https)

  Habilita TLS + HTTP/2. Ten en cuenta que esto cambia a TLS solo cuando también se usa la opción [`server.proxy`](./server-options#server-proxy).
...
- **Tipo:** `boolean | string`
- **Por defecto:** [`server.open`](./server-options#server-open)
...
- **Por defecto:** [`server.proxy`](./server-options#server-proxy)
...
- **Por defecto:** [`server.cors`](./server-options#server-proxy)
